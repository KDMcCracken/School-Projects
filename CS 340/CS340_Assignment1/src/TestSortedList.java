...
public class TestSortedList {
    //Test driver for SortedList
    //Do not send me this file
    ...
    public void testIntList(Scanner scan, boolean prompt) {
        ...
        System.out.print("Found: " + list3.find(scan.nextInt()));
    ...
    public void testStringList(Scanner scan, boolean prompt) {
        ...
        System.out.print("Found: " + list3.find(scan.nextLine()));
        System.out.println(list3);
    }
    ...
    public static void main(String args[]) throws IOException {
        if (args.length == 0) { //Error
            System.out.println("Error: you must provide at least one command line argument: the data type of "
                            + "the input. 1 means integers and 2 means strings");
        }
